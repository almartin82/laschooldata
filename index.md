...
**[Full documentation](https://almartin82.github.io/laschooldata/)** —
...
Charles)](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/calcasieu-hurricane-1.png)
...
![Hispanic Enrollment
Surging](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/hispanic-surge-1.png)

Hispanic Enrollment Surging
...
|--------------------|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| **Enrollment**     | 2019-2024            | [`fetch_enr()`](https://almartin82.github.io/laschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/laschooldata/reference/fetch_enr_multi.md)                             | State, district, school. Race, gender, FRPL, LEP    |
| **Assessments**    | 2018-2019, 2021-2025 | [`fetch_assessment()`](https://almartin82.github.io/laschooldata/reference/fetch_assessment.md) / [`fetch_assessment_multi()`](https://almartin82.github.io/laschooldata/reference/fetch_assessment_multi.md) | LEAP 2025. ELA, Math, Science, Social Studies       |
| **Directory**      | 2026                 | [`fetch_directory()`](https://almartin82.github.io/laschooldata/reference/fetch_directory.md)                                                                                                                 | School names, addresses, coordinates, grades served |
...
> See
> [DATA-CATEGORY-TAXONOMY.md](https://almartin82.github.io/laschooldata/DATA-CATEGORY-TAXONOMY.md)
...
- [Full documentation](https://almartin82.github.io/laschooldata/) — all
  15 stories with interactive charts
- [Enrollment
  trends](https://almartin82.github.io/laschooldata/articles/enrollment-trends.html)
  — 15 stories
- [Function
  reference](https://almartin82.github.io/laschooldata/reference/)
...
2.  **No “Orleans Parish” district** exists in the LDOE data –
    post-Katrina reorganization split New Orleans schools across
    multiple entities
3.  **No charter school district** – charter schools are included with
    their authorizing parish
...
![Louisiana Statewide
Enrollment](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/state-growth-1.png)

Louisiana Statewide Enrollment
...
Districts](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/top-districts-1.png)

Louisiana’s Five Largest Districts
...
![Caddo Parish
Decline](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/caddo-decline-1.png)

Caddo Parish Decline
...
![Pre-K Enrollment Cratered During
COVID](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/prek-covid-1.png)

Pre-K Enrollment Cratered During COVID
...
Level](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/covid-kindergarten-1.png)
...
Rate](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/econ-state-1.png)
...
![Highest Poverty
Districts](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/econ-disadvantage-1.png)
...
![Delta Parishes Losing
Students](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/rural-decline-1.png)

Delta Parishes Losing Students
...
![Jefferson Parish Largest but
Shrinking](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/jefferson-decline-1.png)

Jefferson Parish Largest but Shrinking
...
![I-10/I-12 Corridor
Parishes](https://almartin82.github.io/laschooldata/articles/enrollment-trends_files/figure-html/i10-growth-1.png)

I-10/I-12 Corridor Parishes
