...
Python wrapper for Louisiana school enrollment data.

This is a thin rpy2 wrapper around the [laschooldata](https://github.com/almartin82/laschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `laschooldata` R package installed
...
# Fetch one year
df = la.fetch_enr(2025)

# Fetch multiple years
df_multi = la.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
